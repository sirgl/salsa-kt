...
class DerivedQueryDbTest {
    ...
    fun testQueryChangesAfterInputsChanged() {
        ...
        q1Db[1] = "1"
        q1Db[2] = "2"
        val concat: QueryDb<Pair<Int, Int>, String> = DependencyTrackingDerivedQueryDbImpl(runtime, Concat2Query(q1Db), InMemoryDerivedCache())
        assertEquals("12", concat[runtime.topLevelFrame, 1 to 2])
        q1Db[1] = "3"
        assertEquals("32", concat[runtime.topLevelFrame, 1 to 2])
    }
    ...
    fun testDerivedNotUpdatedIfResultTheSame() {
        ...
        q1Db[1] = 10
        q2Db[1] = 20
        val sum: QueryDb<Pair<Int, Int>, CountedInt> = DependencyTrackingDerivedQueryDbImpl(runtime, SumQuery(q1Db, q2Db), InMemoryDerivedCache())
        val sum1 = sum[runtime.topLevelFrame, 1 to 1]
        q1Db[1] = 5
        q2Db[1] = 25
        val sum2 = sum[runtime.topLevelFrame, 1 to 1]
    ...
    fun testEventsNotChanged1LevelDerived() {
        ...
        assertEquals(concatQuery[runtime.topLevelFrame, 1 to 2], "foobar")
        qDb[1] = "fo"
        qDb[2] = "obar"
    ...
    fun testEventsChanged1LevelDerived() {
        ...
        assertEquals(concatQuery[runtime.topLevelFrame, 1 to 2], "bazbar")
        assertEquals(listOf(
            PushFrame(key = Concat2Query.key),
    ...
    fun testEventsChanged2LevelDerived() {
        ...
        assertEquals(concat3QDb[runtime.topLevelFrame, listOf(1, 2, 3)], "foobarbaz")
        qDb[1] = "fo"
        qDb[2] = "obar"
        val events: MutableList<RuntimeEvent> = ArrayList()
        runtime.eventLogger = { event ->
